                        ...
                        <nav class="" role="navigation">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    ...
                                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                        <img src="images/img.jpg" alt=""><%= session.getAttribute("email")%>
                                        <span class=" fa fa-angle-down"></span>
                                    </a>
                                    <%
                                        }
                                    ...
                                    <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                                        <li><a href="PatientProfile.jsp">  Profile</a>
                                        </li>
...
%>         
 ...
 <%--        	        <div class="row">
                  ...
                  <div class="col-md-6 form-group has-success">
                      ...
                      <input type="number" name="mobnum" value="<%= mobnum %>" class="form-control" id="mobnum" readonly="true">
                  </div>
                 
                  <div class="col-md-6 form-group has-success">
                       <label for="marStatus">Marital Status</label>
                       <input type="text" name="marStatus" value="<%= marStatus %>" class="form-control" id="marStatus" readonly="true">
                     </div>
                  
                <div class="col-md-6 form-group has-success">
                	  <label for="dhospName">Gender</label>
                      <input type="text" name="gender" value="<%= gender %>"class="form-control" id="gender" readonly="true">
                 </div>
  ...
  --%>            
             ...
             <!-- New DIV start Here -->
              <div class="row" align="center">
                 	<form action="InsertPatientProfile.html" method="get">
					...
					<div class="col-md-6 form-group has-success">
                       ...
                       <input type="text" name="email" class="form-control" id="email" value="<%= email %>" readonly="readonly">
                     </div>	
                 ...
                 <div class="col-md-6 form-group has-success">
                  ...
                  <div class="col-md-6 form-group has-success">
                   ...
                   <div class="col-md-6 form-group has-success">
                       ...
                       <input type="number" name="height" class="form-control" id="pHeight"placeholder="Height">
                     </div>
                     
                  <div class="col-md-6 form-group has-success">
                     <label for="weight">Weight</label>     
                      <input type="number" name="weight" class="form-control" id="pWeight" placeholder="Weight">
                   </div>
