...
jQuery(document).ready(function() {
    ...
    */
    $('.register form').submit(function(){
        ...
        $(this).find("label[for='doctName']").html('Doctor Name');
        ...
        var doctName = $(this).find('input#doctName').val();
        ...
        if(password == '') {
         ...
         if(doctName == '') {
            $(this).find("label[for='doctName']").append("<span style='display:none' class='red'> - Please enter a valid Docotr Name.</span>");
            $(this).find("label[for='doctName'] span").fadeIn('medium');
            return false;
        }
    });
