        ...
        <div class="left_col scroll-view">
                    ...
                    <div class="navbar nav_title" style="border: 0;">
                        ...
                        <div class="profile">
                            ...
                            <div class="profile_info">
                                <span>Welcome</span>
                                <h4> <%= session.getAttribute("doctName")%> </h4>
...
<br><br><br>   <br><br>
 ...
 try
 {
     String userid = (String)session.getAttribute("doctRegNo");
      Connection con1 = Database.dataConnection();
      Statement stmt1 = con1.createStatement();
      String str1 = "Select * from prescriptionpojo where doctRegNo ='"+userid+"';";
