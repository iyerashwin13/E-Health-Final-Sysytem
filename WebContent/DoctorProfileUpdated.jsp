<%@page import="org.springframework.scheduling.quartz.SimpleTriggerBean"%>
...
String str1 = "Select * from doctorupdateprofile where doctRegNo='" + doctRegNo + "' ";
Statement stmt1 = con.createStatement();
ResultSet rs1 = stmt.executeQuery(str1);
while(rs1.next())
       {
			userName=rs1.getString(1);
			adharNo=rs1.getString(3);
			dob=rs1.getString(4);
			addr=rs1.getString(5);
           ...
           <div class="panel-body">
    	      ...
    	      <div class="panel-body">
        	        <div class="row">
                       ...
                       <input type="text" name="userName" class="form-control" id="userName" value="<%= userName %>" placeholder="Doctor User Name">
                     </div>	
					<div class="col-md-6 form-group has-success">
                       <label for="adhar">Social Security Number</label>
                       <input type="number" name="adharNo" class="form-control" id="adharNo" value="<%= adharNo %>" placeholder="Social Security Number">
                     </div>
                   
                   <div class="col-md-6 form-group has-success">
                       <label for="dob">Date of Birth</label>
                       <input type="date" name="dob" class="form-control" id="dob" value="<%= dob %>" placeholder="Date of Birth">
                     </div>
                 ...
                 <div class="col-md-6 form-group has-success">
                   ...
                   <div class="col-md-6 form-group has-success">
                       ...
                       <input type="number" name="height" class="form-control" id="height" value="<%= height %>" placeholder="Height" min=120>
                     </div>
                     
                  <div class="col-md-6 form-group has-success">
                     <label for="weight">Weight</label>     
                      <input type="number" name="weight" class="form-control" id="weight" value="<%= weight %>" placeholder="Weight" min=1>
                   </div>
